...
public class MercatorStandardParallelParamWrapper extends CoordinateSystemParamWrapper {

    private static final Logger log = LoggerFactory.getLogger(MercatorStandardParallelParamWrapper.class.getName());

    public MercatorStandardParallelParamWrapper(String prefix, Map<String, Object> input) throws CoordinateConversionException {
        log.debug("Entering MercatorStandardParallelParamWrapper");

        InputVerifier iv = new InputVerifier();
        StringToVal stringToVal = new StringToVal();

        setParameters(new MercatorStandardParallelParameters(
                ...
                stringToVal.stringToDouble( "1.0" ),
        ...
        log.debug("Leaving MercatorStandardParallelParamWrapper");
    }
}